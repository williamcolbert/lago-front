...
export type AdyenForCreateAndEditSuccessRedirectUrlFragment = { __typename?: 'AdyenProvider', id: string, apiKey: string, merchantAccount: string, successRedirectUrl?: string | null };
...
export type AddEditAdyenSuccessRedirectUrlMutationVariables = Exact<{
  input: AddAdyenPaymentProviderInput;
}>;


export type AddEditAdyenSuccessRedirectUrlMutation = { __typename?: 'Mutation', addAdyenPaymentProvider?: { __typename?: 'AdyenProvider', id: string, successRedirectUrl?: string | null } | null };

export type AddEditGocardlessSuccessRedirectUrlMutationVariables = Exact<{
  input: AddGocardlessPaymentProviderInput;
}>;


export type AddEditGocardlessSuccessRedirectUrlMutation = { __typename?: 'Mutation', addGocardlessPaymentProvider?: { __typename?: 'GocardlessProvider', id: string, successRedirectUrl?: string | null } | null };

export type AddEditStripeSuccessRedirectUrlMutationVariables = Exact<{
  input: AddStripePaymentProviderInput;
}>;


export type AddEditStripeSuccessRedirectUrlMutation = { __typename?: 'Mutation', addStripePaymentProvider?: { __typename?: 'StripeProvider', id: string, successRedirectUrl?: string | null } | null };
...
export const AddEditAdyenSuccessRedirectUrlDocument = gql`
  ...
  addAdyenPaymentProvider(input: $input) {
    ...
    `;
export type AddEditAdyenSuccessRedirectUrlMutationFn = Apollo.MutationFunction<AddEditAdyenSuccessRedirectUrlMutation, AddEditAdyenSuccessRedirectUrlMutationVariables>;

/**
 * __useAddEditAdyenSuccessRedirectUrlMutation__
 *
 * To run a mutation, you first call `useAddEditAdyenSuccessRedirectUrlMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddEditAdyenSuccessRedirectUrlMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addEditAdyenSuccessRedirectUrlMutation, { data, loading, error }] = useAddEditAdyenSuccessRedirectUrlMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddEditAdyenSuccessRedirectUrlMutation(baseOptions?: Apollo.MutationHookOptions<AddEditAdyenSuccessRedirectUrlMutation, AddEditAdyenSuccessRedirectUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddEditAdyenSuccessRedirectUrlMutation, AddEditAdyenSuccessRedirectUrlMutationVariables>(AddEditAdyenSuccessRedirectUrlDocument, options);
      }
export type AddEditAdyenSuccessRedirectUrlMutationHookResult = ReturnType<typeof useAddEditAdyenSuccessRedirectUrlMutation>;
export type AddEditAdyenSuccessRedirectUrlMutationResult = Apollo.MutationResult<AddEditAdyenSuccessRedirectUrlMutation>;
export type AddEditAdyenSuccessRedirectUrlMutationOptions = Apollo.BaseMutationOptions<AddEditAdyenSuccessRedirectUrlMutation, AddEditAdyenSuccessRedirectUrlMutationVariables>;
export const AddEditGocardlessSuccessRedirectUrlDocument = gql`
  ...
  addGocardlessPaymentProvider(input: $input) {
    ...
    `;
export type AddEditGocardlessSuccessRedirectUrlMutationFn = Apollo.MutationFunction<AddEditGocardlessSuccessRedirectUrlMutation, AddEditGocardlessSuccessRedirectUrlMutationVariables>;

/**
 * __useAddEditGocardlessSuccessRedirectUrlMutation__
 *
 * To run a mutation, you first call `useAddEditGocardlessSuccessRedirectUrlMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddEditGocardlessSuccessRedirectUrlMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addEditGocardlessSuccessRedirectUrlMutation, { data, loading, error }] = useAddEditGocardlessSuccessRedirectUrlMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddEditGocardlessSuccessRedirectUrlMutation(baseOptions?: Apollo.MutationHookOptions<AddEditGocardlessSuccessRedirectUrlMutation, AddEditGocardlessSuccessRedirectUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddEditGocardlessSuccessRedirectUrlMutation, AddEditGocardlessSuccessRedirectUrlMutationVariables>(AddEditGocardlessSuccessRedirectUrlDocument, options);
      }
export type AddEditGocardlessSuccessRedirectUrlMutationHookResult = ReturnType<typeof useAddEditGocardlessSuccessRedirectUrlMutation>;
export type AddEditGocardlessSuccessRedirectUrlMutationResult = Apollo.MutationResult<AddEditGocardlessSuccessRedirectUrlMutation>;
export type AddEditGocardlessSuccessRedirectUrlMutationOptions = Apollo.BaseMutationOptions<AddEditGocardlessSuccessRedirectUrlMutation, AddEditGocardlessSuccessRedirectUrlMutationVariables>;
export const AddEditStripeSuccessRedirectUrlDocument = gql`
  ...
  addStripePaymentProvider(input: $input) {
    ...
    `;
export type AddEditStripeSuccessRedirectUrlMutationFn = Apollo.MutationFunction<AddEditStripeSuccessRedirectUrlMutation, AddEditStripeSuccessRedirectUrlMutationVariables>;

/**
 * __useAddEditStripeSuccessRedirectUrlMutation__
 *
 * To run a mutation, you first call `useAddEditStripeSuccessRedirectUrlMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddEditStripeSuccessRedirectUrlMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addEditStripeSuccessRedirectUrlMutation, { data, loading, error }] = useAddEditStripeSuccessRedirectUrlMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddEditStripeSuccessRedirectUrlMutation(baseOptions?: Apollo.MutationHookOptions<AddEditStripeSuccessRedirectUrlMutation, AddEditStripeSuccessRedirectUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddEditStripeSuccessRedirectUrlMutation, AddEditStripeSuccessRedirectUrlMutationVariables>(AddEditStripeSuccessRedirectUrlDocument, options);
      }
export type AddEditStripeSuccessRedirectUrlMutationHookResult = ReturnType<typeof useAddEditStripeSuccessRedirectUrlMutation>;
export type AddEditStripeSuccessRedirectUrlMutationResult = Apollo.MutationResult<AddEditStripeSuccessRedirectUrlMutation>;
export type AddEditStripeSuccessRedirectUrlMutationOptions = Apollo.BaseMutationOptions<AddEditStripeSuccessRedirectUrlMutation, AddEditStripeSuccessRedirectUrlMutationVariables>;
